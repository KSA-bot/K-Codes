  ...
  if (message.content.startsWith(prefix+'تقديم'))
      {
          ...
          var embed = new Discord.RichEmbed()
              ...
              .setColor(`GREEN`)
              client.channels.get("451276878540439552").send(embed)
...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『K،Codes』 『اسم البوت』", true)
      
      .addField("『@! ِ'. Malak The Angel ✧#6666』『مصمم البوت』", true)
...
const secreT = [
  ...
  "**نحن نكتب ما ل�� نستطيع ان نقول وما نريد ان يكون**.", 
]
...
القسم الثالث مصمم البوت | ! ِ'. Malak The Angel ✧#6666
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
`)
...
👑^^mute  『لعطاء الشخص ميوت كتابي』
👑^^unmute  『لفك الميوت الكاتبي عن الشخص』
👑^^ct  مـلاحظه: الاسم انت تختاره『لي ان��اء روم كتابي』
👑^^cv  مـلاحظه: الاسم انت تختاره『لي انشاء روم صوتي』
👑^^delet  『كـود يحذف الـروم سواء صوتي او كتابي』
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.find("name", "K،Codes")
